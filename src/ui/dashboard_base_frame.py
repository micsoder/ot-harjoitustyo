...
class DashboardBaseFrame(BaseFrame):
    ...
    def load_data(self):
        self.zone_data.load_data_from_table(self.view_id, self.title, self.description)
    
    def save_data(self):
        self.zone_data.save_data_to_database(self.view_id, self.title, self.description)
