...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_negatiivisen_summan_lataminen_ei_muuta_saldoa(self):
        self.kortti.lataa_rahaa(-2000)
        
        self.assertEqual(self.kortti.saldo_euroina(), 10)
        
    def test_osta_edullinen_kun_saldolla_on_tasaraha(self):
        kortti = Maksukortti(250)
        kortti.syo_edullisesti()
        
        self.assertEqual(kortti.saldo_euroina(), 0)
        
    def test_osta_maukkaan_kun_saldolla_on_tasaraha(self):
