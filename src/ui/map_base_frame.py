...
class MapBaseFrame():
    ...
    def retrive_zone_image(self):      
        ...
        self.zone_image = customtkinter.CTkImage(light_image=Image.open(image_path), size = (image_width, image_height))
        self.image_label = customtkinter.CTkLabel(self.map_frame, image=self.zone_image, text = '')
