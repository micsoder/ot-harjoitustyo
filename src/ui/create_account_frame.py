...
from logic.create_account import CreateAccount
from ui.create_login_frame import CreateLoginFrame

class CreateAccountFrame():

    def __init__(self, window, font1, font2, font3, font4, login_callback):
        self.window = window
        self.font1 = font1
        self.font2 = font2
        self.font3 = font3
    ...
    def create_account_label(self):
        create_account_label = customtkinter.CTkLabel(self.frame, font = self.font1, text = 'Create account', text_color = '#fff', bg_color = '#001220')
        create_account_label.place(x = 200, y = 20)
    
    def create_account_button(self):
        create_account_button = customtkinter.CTkButton(self.frame, font = self.font2, text_color = '#fff', text = 'Create account', fg_color = '#00965d', hover_color = '#006e44', bg_color = '#121111', cursor = 'hand2', corner_radius = 5, width = 120)
        create_account_button.place(x = 200, y = 220)
