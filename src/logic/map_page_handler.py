...
class MapPageHandler():
    ...
    def fetch_zone_ids_within_current_map_id(self, current_map_page_id):
        ...
        self.database.cursor.execute('SELECT zone_id FROM map_page WHERE map_id = ?', (current_map_page_id,))
    ...
    def fetch_zone_parent_for_current_map(self, current_map_page_id):
        ...
        self.database.cursor.execute('SELECT map_id FROM map_page WHERE zone_id = ?', (current_map_page_id,))
